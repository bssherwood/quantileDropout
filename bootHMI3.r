...
B2 = c(    3,  0,  0,  0,  0,  0,  0, rep(0,0), -1)   
B3 = c(    3,  0,  0,  0,  0,  0,  0, rep(0,1), -1) 
B4 = c(    3,  0,  0,  0,  0,  0,  0, rep(0,2), -1) 
B5 = c(    3,  0,  0,  0,  0,  0,  0, rep(0,3), -1)  
####################################################
...
# sd( gmse )/sqrt(nsim)
	...
	saveRDS( list(n=n, ms=ms, rhos=rhos, taus=taus, BTrue=BTrue, error=error, 
					...
					file=paste(error,"n",n,"mi3xyTrue.RDS", sep="") )
