...
ns = 100#c(1000,5000,10000)#c(100, 500,1000,5000,10000) # ns = c(300, 500) # 
ms = c(2,3)# 5)
		...
		for( rho in rhos ){
			...
			for( m in ms ){
				...
				for( tau in taus ){
					...
					bootN <- mapply(function(xx) boot.rq( XZbso, xx, tau=tau, R=bootNum,bsmethod="xy" )$B[,1:length(B)], Yo, SIMPLIFY=FALSE)
